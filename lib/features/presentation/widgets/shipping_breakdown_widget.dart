...
class ShippingBreakdownWidget extends StatefulWidget {
  ...
  @override
  State<ShippingBreakdownWidget> createState() =>
      _ShippingBreakdownWidgetState();
}

class _ShippingBreakdownWidgetState extends State<ShippingBreakdownWidget> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(_calculateEstimatedTotal(widget.cartItems).toStringAsFixed(2)),
          Row(
            children: [
          ...
          Row(
            children: [
              Text('Goods Value'),
              Spacer(),
              Text(_calculateGoodsValue(widget.cartItems).toStringAsFixed(2)),
            ],
          ),
          Row(
            children: [
              Text('Platform Fee'),
              Spacer(),
              Text(_calculatePlatformFees(widget.cartItems).toStringAsFixed(2)),
            ],
          ),
          Row(
            children: [
              ...
              Spacer(),
              Text(
                _calculateLocalTransitFees(widget.cartItems).toStringAsFixed(2),
              ),
            ],
          ),
          Row(
