...
class _W2DClient implements W2DClient {
  ...
  @override
  Future<CategoriesModel> getCategoryHierarchy() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<ProductViewModel> getProductDetail(String id) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProductViewModel _value;
    try {
      _value = ProductViewModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<UpdatedCartModel> updateCart(Map<String, dynamic> body) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<UpdatedCartModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/cart/update/',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdatedCartModel _value;
    try {
      _value = UpdatedCartModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<SearchResultAutoCompleteModel> searchProductAutoComplete(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SearchResultAutoCompleteModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SearchResultAutoCompleteModel _value;
    try {
      _value = SearchResultAutoCompleteModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
